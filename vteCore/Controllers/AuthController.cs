...
namespace vteCore.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(ILogger<AuthController> log, ISender send, TokenService tkserv,IUserService usrmgr,UserMap mapuser) { 
        ...
        [Authorize]
        [HttpPost]
        public IActionResult SaveModel(UserModel model)
        {
