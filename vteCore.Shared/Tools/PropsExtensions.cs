...
namespace vteCore.Shared.Tools
{
    ...
    this Type type)
        ...
        public static Dictionary<string, Func<object, object>> GetSortedGetters(this Type type,bool onlyDisplay=false)
        {
            ...
            var metaproperties = metadataType.MetadataClassType.GetProperties().ToDictionary(e=> e.Name,e=>e.GetCustomAttribute<DisplayAttribute>(true));
            ...
            return type.GetProperties()
                .Select(p =>
                {
                    ...
                    var metadisplay = metaproperties[p.Name];
                    if (metadisplay != null)
                        display = metadisplay;
